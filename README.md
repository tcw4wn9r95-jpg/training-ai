...
- **Four ways to log a meal** — type the ingredients in, describe what went in and let Coach Claudio work it out (built for smoothies and anything else a photo can't show), photograph the nutrition label and say how much you ate, or photograph the plate for an AI estimate; every route ends in an editable list you check before saving, and AI estimates carry a confidence flag
...
- **"What's in the pot?"** — photograph the pan before you serve and be told how much to put on your plate: one weight for anything mixed (a fried rice, a stew, a bake) with the per-100 g numbers behind it and a −/+ stepper to adjust in 25 g steps, or a weight per component when the foods are separate; say what went in and the weights stop being guesses, and logging it records the grams you actually settled on
